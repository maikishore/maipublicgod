...
function Editors(props) {
 ...
 function TKS() {
 const [editorWidth,setWidth]=React.useState("w-full")
const [notecardWidth,setnoteCardWidth]=React.useState("w-1/4")
const [noteVisable,setNoteVisible]=React.useState("hidden")
      ...
      <div className="w-full h-screen bg-white-400">
        <div className="grid grid-flow-row grid-rows-8">
          ...
          <div className="flex justify-center items-baseline">
            <div className={`${editorWidth} bg-yellow-400`}>
              <Editors widthFunc={() =>{
              setWidth("w-3/4")
              setnoteCardWidth("w-1/4")
              setNoteVisible("visible")
            }} />
            </div>

            <div className={`${notecardWidth}`}>Hello</div>
          </div>
        </div>
      </div>
    </div>
