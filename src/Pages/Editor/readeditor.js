  ...
  return (
    <div class="">
      ...
      {loading ? (
        ...
        <div class="w-full h-screen bg-white-400">
          <div class="flex flex-col  ">
            <div class="p-2 text-6xl row-span-1 ">
              <div class="form-control">
                <div class="flex ">
                  <input
                    ...
                    type="text"
                    placeholder="Title"
                    class="w-11/12 input input-bordered text-2xl font-bold"
                  />
                  <button
                    onClick={async (e) => {
                    ...
                    class="ml-3 px-6 btn btn-primary "
                  >
                    Update
                  </button>
                </div>
            ...
            <div class="flex justify-center items-baseline">
              <div class={`${editorWidth ? "m-4 w-full" : "w-2/3"} `}>
                <RawEditor
              ...
              <div class={`${editorWidth ? "hidden" : "visible w-1/3 "}`}>
                <Notecard
                  leveldiv={
