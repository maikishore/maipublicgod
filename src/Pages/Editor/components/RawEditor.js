...
function RawEditor(props) {
  ...
  const textcolormenu = (
    <div className="dropdown">
      <div tabindex="0" className={styles.iconactive}>
        <BiFontColor className={`text-lg text-${textColor}-800`} />
      </div>
      <ul
        tabindex="0"
  ...
  return (
    <div className="w-full">
      {props.editor && (
        <BubbleMenus editor={props.editor} noteFunc={props.noteFunc} />
      )}
